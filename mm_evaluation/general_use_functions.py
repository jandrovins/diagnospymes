...
def get_autoevaluation(pyme):
    # When login is working, this should be edited accordingly. pyme in the filter query is the id of the pyme that is filling que autoevaluation.
    ...
    return Autoevaluation(pyme=get_object_or_404(PYME, pk=1),
